...
export default function AddProduct() {
  ...
  // console.log("Category Data addProduct:", categories);
  // console.log("Products addProduct:", products);

  const handleSubmit = async (e) => {
  e.preventDefault();

  const { id, name, description, price, categoryId, image } = productData;
  ...
  try {
    await dispatch(addProduct(newProduct)); // לא צריך unwrap
